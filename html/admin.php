...
$sqlNivel = $conn->query("SELECT admin FROM usuario WHERE nome = '$usuario'");
         ...
         <section id="livros">
            ...
            <table>
               ...
               <tbody>
                  ...
                  $sqlLivro = "SELECT livro.*, autor.nome_autor, editora.nome_editora FROM livro INNER JOIN autor ON livro.fk_autor = autor.id_autor INNER JOIN editora ON livro.fk_editora = editora.id_editora ORDER BY id_livro DESC";
